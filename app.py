...
st.title("Donne moi ton thème et je fais le lien avec tes études")
...
if st.button("Let's go !"):
    with st.spinner("Patience, patience..."):
        # Ton prompt
        prompt_text = f"""Tu t'adresses à un étudiant en bachelor de management du sport qui a environ 18 ans. Adresse toi à lui/elle comme si tu le connaissais. Tu le tutoie.
        Ton but c'est de faire le lien tordu entre le thème suivants et ses études.
        Dans ta réponse, tu intègres subtilement et aléatoirement 3 expressions issues de la liste suivante, pas plus, ni entre guillemets ni en gras : 
        1. Définition Boomer
